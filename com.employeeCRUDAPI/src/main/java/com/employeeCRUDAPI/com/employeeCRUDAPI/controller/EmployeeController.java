package com.employeeCRUDAPI.com.employeeCRUDAPI.controller;
...
import com.employeeCRUDAPI.com.employeeCRUDAPI.repository.EmployeeRepository;
...
public class EmployeeController {
	...
	public String updateEmployeeById(@PathVariable long empid, @RequestBody Employee employee) {
		...
		if (emp.isPresent()) {
			...
			return "Employee details not found for empid" + empid;
	}
	
	@DeleteMapping("/employees/{empid}")
	public String deleteEmployeeByEmpId(@PathVariable Long empid) {
		employeeRepository.deleteById(empid);
		return"Employee deleted successflly";
	}
